Onboarding. With Aleksandra and Mathias Hecht Alexander. 
...
- Front Office is an immature area and they have most customizations. The product behind is immature.
- Product Areas are also involved but were used to just passing on their configurations to someone else. 
They accept the SimCorp One but would like to continue with the same old approach. There is conflict here.
They demand to have the vNext version and so on. 
It has to become clear to everyone that people are not delivering configurations in a vacuum - they get to actual client
environments, and in much shorter times as before. The release cycle time is being reduced as much as possible.
Changes have an effect much earlier. The whole perspective needs to change. And the quality of the configurations.
We cannot rely on someone intervening and making things work at some point. 
People are used to the silos and the associated way of working. 
